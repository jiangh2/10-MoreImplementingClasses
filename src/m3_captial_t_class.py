...
"""  # Hao Jiang: 1. PUT YOUR NAME IN THE ABOVE LINE.
...
class CapitalT(object):
    ...
    def __init__(self, intersection_center, width, height, letter_thickness):
        ...
        """
        h_rect_upper_left = rg.Point(intersection_center.x - width/2, intersection_center.y - letter_thickness/2)
        h_rect_lower_right = rg.Point(intersection_center.x + width/2, intersection_center.y + letter_thickness/2)
        v_rect_upper_left = rg.Point(intersection_center.x - letter_thickness/2, intersection_center.y - letter_thickness/2)
        v_rect_lower_right = rg.Point(intersection_center.x + letter_thickness/2, intersection_center.y - letter_thickness/2 + height)
